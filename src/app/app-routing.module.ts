...
const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'add_course', component: AddCourseComponent, canDeactivate: [CanDeactivateGuard] },
      ...
      { path: 'add_course_package', component: AddcoursePackageComponent, canDeactivate: [CanDeactivateGuard]},
      { path: 'edit_course_package', component: EditcoursePackageComponent},
      { path: 'add_schedule', component: AddcourseScheduleComponent, canDeactivate: [CanDeactivateGuard]},
      { path: 'edit_schedule', component: EditcourseScheduleComponent},
      { path: 'add_user', component: AddEmployeeComponent, canDeactivate: [CanDeactivateGuard]},
      { path: 'edit_user', component: EditEmployeeComponent},
      { path: 'add_role', component: AddRoleComponent, canDeactivate: [CanDeactivateGuard]},
